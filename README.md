...
Проект полезен в ситуациях, когда системы уже пишут логи, содержащие события ошибок, с которыми хочется работать как с отдельными проблемами: видеть группы однотипных событий, смотреть детали ошибки и анализировать динамику их возникновения во времени.
