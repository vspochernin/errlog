...
public enum ErrapiErrorType {
    ...
    // Ошибки неуникальности при регистрации.
    ...
    // Ошибк валидации полей пользователей.
    ...
    // Ошибки изменения пользователей.
