        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                ...
                                - регистрация и аутентификация пользователей, изменение пароля,
                                - управление ролями пользователей,
                                - получение списка доступных полей и операций фильтрации,
                                - получение списка групп событий ошибок с возможностью фильтрации,
                                - получение списка событий ошибок с возможностью фильтрации,
                                - получение полной информации о конкретном событии ошибки,
