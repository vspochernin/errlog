...
@Schema(description = "Частичная информация о событии ошибки")
public record ErrorSmallDto(

        @Schema(description = "Идентификатор события (UUID)", example = "9eefb744-0afb-49c1-93d1-ebb31aedcb5e")
        String eventId,

        @Schema(description = "Время события (UTC)", example = "2026-03-29T11:56:13.800Z")
        Instant timestamp,

        @Schema(description = "Тип источника события", example = "java-spring-logback")
        String sourceType,

        @Schema(description = "Название сервиса", example = "jerrgen-alpha")
        String service,

        @Schema(description = "Уровень логирования события", example = "ERROR")
        String level,

        @Schema(description = "Сообщение события", example = "There is exception with int: -463855931 and double: 0.39060667043203356")
        String messageFormatted,

        @Schema(description = "Fingerprint события в (строковое представление UInt64)", example = "16018207979116224727")
        String fingerprint,
